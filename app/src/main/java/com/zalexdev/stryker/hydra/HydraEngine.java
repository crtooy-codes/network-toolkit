...
public final class HydraEngine {
    ...
    private String buildCommand(Spec spec) {
        ...
        if (needLogin) {
            if (notEmpty(spec.singleLogin)) {
                ...
                cmd.append("-L /sdcard/OpenLPS/wordlists/").append(spec.loginWordlist).append(' ');
            }
        }
        if (notEmpty(spec.singlePassword)) {
            ...
            cmd.append("-P /sdcard/OpenLPS/wordlists/").append(spec.passwordWordlist).append(' ');
        }
    ...
    private void openTranscript(Spec spec) {
        try {
            File dir = new File("/sdcard/OpenLPS/hydra");
            dir.mkdirs();
