...
public class InstallService extends Service {
    ...
    public static final String ACTION_INSTALL = "com.openlps.networktoolkit.install.INSTALL";
    public static final String ACTION_CANCEL = "com.openlps.networktoolkit.install.CANCEL";
    public static final String ACTION_UPDATED = "com.openlps.networktoolkit.install.UPDATED";
        ...
        try {
            switch (tool) {
                case TOOL_NUCLEI: {
                    ...
                    return Core.contains(probe, "nuclei") || core.checkFile("/data/local/openlps/release/usr/bin/nuclei");
                }
                case TOOL_HYDRA: {
                    ...
                    return Core.contains(probe, "Hydra v") || Core.contains(probe, "by van Hauser")
                            || core.checkFile("/data/local/openlps/release/usr/bin/hydra");
                }
                case TOOL_METASPLOIT:
                default:
                    return core.checkFile("/data/local/openlps/release/metasploit-framework/msfconsole");
            }
        } catch (Throwable t) {
