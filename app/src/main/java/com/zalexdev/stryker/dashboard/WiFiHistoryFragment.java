...
public class WiFiHistoryFragment extends Fragment {
    ...
    private void exportNetworks() {
        try {
            ...
            try {
                @SuppressLint("SdCardPath") File file = new File("/sdcard/OpenLPS/saved_networks.csv");
                FileWriter writer = new FileWriter(file);
                writer.append(builder.toString());
                writer.flush();
                writer.close();
                core.toaster("Saved networks exported to /sdcard/OpenLPS/saved_networks.csv");
            } catch (Exception e) {
                e.printStackTrace();
                    ...
                    new MaterialAlertDialogBuilder(context)
                            ...
                            .setPositiveButton(android.R.string.yes, (di, i) -> {
                                ...
                                for (String line : lines) {
                                    core.customCommand("echo '" + line.replace("'", "\\'") + "' > /sdcard/OpenLPS/saved_networks.csv", true);
                                }
                                core.toaster("Saved networks exported to /sdcard/OpenLPS/saved_networks.csv");
                            })
    ...
    private void importNetworks() {
        ...
        value.setText("/sdcard/OpenLPS/saved_networks.csv");
