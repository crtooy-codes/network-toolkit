...
public class Dashboard extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        if (!core.getBoolean("exploits_v30")) {
            new Thread(() -> {
                if (!core.checkFile("/sdcard/OpenLPS/exploits/checker.py")) {
                    Snackbar s = Snackbar.make(activity.findViewById(android.R.id.content),
                            R.string.dashboard_updating_modules, 60000);
                    ...
                    core.copyFile("/data/data/com.openlps.networktoolkit/files/checker.py", "/data/local/openlps/release/exploits/checker.py");
        ...
        if (core.getInt("dashboard_open") == 12 && !core.getBoolean("firstscan")) {
            TapTargetView.showFor(activity,
                    TapTarget.forView(target,
                                    getString(R.string.dashboard_tip_title),
                                    getString(R.string.dashboard_tip_body))
