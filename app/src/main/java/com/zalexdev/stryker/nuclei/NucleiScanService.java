...
public class NucleiScanService extends Service {
    ...
    public static final String ACTION_CANCEL = "com.openlps.networktoolkit.nuclei.CANCEL";
    public static final String ACTION_UPDATED = "com.openlps.networktoolkit.nuclei.UPDATED";
