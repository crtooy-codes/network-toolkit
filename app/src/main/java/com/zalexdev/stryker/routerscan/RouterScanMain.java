...
public class RouterScanMain extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        core = new Core(context);
            ...
            if (!core.checkFile("/data/local/openlps/release/usr/bin/rs")){
            ...
            core.threadChrootCommand("mkdir /sdcard/OpenLPS/rs");
            core.threadChrootCommand("cp /data/local/openlps/release/CORE/RS/* /sdcard/OpenLPS/rs");
