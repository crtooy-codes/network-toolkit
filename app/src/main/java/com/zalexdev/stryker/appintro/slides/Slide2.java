...
public class Slide2 extends Fragment {
    ...
    private void tryGrant() {
        ...
        new Thread(() -> {
            ...
            if (rooted) {
                core.customCommand("pm grant " + BuildConfig.APPLICATION_ID
                        + " android.permission.WRITE_EXTERNAL_STORAGE", true);
                core.customCommand("pm grant " + BuildConfig.APPLICATION_ID
                        + " android.permission.READ_EXTERNAL_STORAGE", true);
                core.customCommand("dumpsys deviceidle whitelist +"
                ...
                uiSafe(() -> {
                    refreshStatuses();
                    boolean alreadyInstalled = core.checkFolder("/data/local/openlps/release/sdcard/OpenLPS")
                            && core.checkFile("/data/local/openlps/release/4.0");
                    if (alreadyInstalled) {
    ...
    private boolean batteryWhitelisted() {
        try {
            ...
            return pm != null && pm.isIgnoringBatteryOptimizations("com.openlps.networktoolkit");
        } catch (Throwable t) {
            return false;
        }
    }
    ...
    private void copyAssets() {
        ...
        for (String filename : files) {
            ...
            try {
                ...
                @SuppressLint("SdCardPath") File outFile = new File("/data/data/com.openlps.networktoolkit/files/", filename);
        ...
        core.customCommand("dos2unix /data/data/com.openlps.networktoolkit/files/*.sh", true);
        core.customCommand("dos2unix /data/data/com.openlps.networktoolkit/files/*root*", true);
    }
