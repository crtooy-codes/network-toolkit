...
public class VNCFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        new Thread(() -> {
            if (!core.checkFolder("/data/local/openlps/release/CORE/VNC"))
    ...
    private void wireInstall() {
        install.setOnClickListener(v -> new MaterialAlertDialogBuilder(context)
                ...
                .setPositiveButton(android.R.string.ok, (di, i) -> new Thread(() -> {
                    core.customCommand("cp /data/data/com.openlps.networktoolkit/files/install_xfce.sh /data/local/openlps/release/CORE/VNC/install.sh");
                    core.customCommand("cp /data/data/com.openlps.networktoolkit/files/uninstall_xfce.sh /data/local/openlps/release/CORE/VNC/uninstall.sh");
                    core.customCommand("dos2unix /data/local/openlps/release/CORE/VNC/install.sh");
                    core.customCommand("dos2unix /data/local/openlps/release/CORE/VNC/uninstall.sh");
                    core.customCommand("chmod 755 /data/local/openlps/release/CORE/VNC/install.sh");
                    core.customCommand("chmod 755 /data/local/openlps/release/CORE/VNC/uninstall.sh");
    ...
    private void runInstallProcess() {
        installProcess = new AdvancedProcess(activity, context, "/CORE/VNC/install.sh", true) {
            ...
            public void onFinished(ArrayList<String> outputList) {
                ...
                core.deleteFile("/data/local/openlps/release/usr/share/backgrounds/xfce/*.png");
                core.copyFile("/data/data/com.openlps.networktoolkit/files/bg1.png", "/data/local/openlps/release/usr/share/backgrounds/xfce/xfce-verticals.png");
                core.copyFile("/data/data/com.openlps.networktoolkit/files/bg3.png", "/data/local/openlps/release/usr/share/backgrounds/xfce/bg3.png");
            }
